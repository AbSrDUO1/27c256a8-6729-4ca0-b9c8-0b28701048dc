...
export const metadata: Metadata = {
  title: "Coffee Corner - The Finest Coffee Experience",
  description: "Explore the rich flavors and aromas at Coffee Corner, your cozy neighborhood coffee shop.",
  openGraph: {
    title: "Coffee Corner - The Finest Coffee Experience",
    description: "Explore the rich flavors and aromas at Coffee Corner, your cozy neighborhood coffee shop.",
    url: "https://www.coffeecorner.com",
    siteName: "Coffee Corner",
    images: [{ url: "https://images.pexels.com/photos/26492562/pexels-photo-26492562.jpeg?auto=compress&cs=tinysrgb&h=650&w=940", alt: "Charming café interior in Geelong featuring vinyl records, blackboard menu, and retro decor." }],
    type: "website",
  },
  twitter: {
